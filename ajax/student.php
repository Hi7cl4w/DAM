<form  name="regform" id="regform" action="ajax/student_update.php" method="post">
    ...
    <div class="form-group">
        <label for="login_input_designation" >Admission Year</label>
        <input type="text" class="form-control" placeholder="<?php echo $adyear; ?> " id="login_input_designation" name="adyear" />
    </div>
