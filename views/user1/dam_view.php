<!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Diciplinary Action 
                        <small>View Diciplinary Actions</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Diciplinary Action</li>
                    </ol>
                </section>
       ...
       <script type="text/javascript" language="javascript" class="init">
        ...
        usertable = {
            tablef: function() {
                ...
                var id="<?php echo $_SESSION['prn']; ?>";
                if (user != '')
                {
                    $.ajax({
                        url: 'ajax/sd_process.php?method=fetchdata',
                        data: {id: id},
                        type: "POST",
                        dataType: 'json',
                        success: function(s) {
                            ...
                            for (var i = 0; i < s.length; i++) {
                                oTable.fnAddData({
                                    ...
                                    "2": s[i][3],
                                     "3": s[i][4],
                                     "4": s[i][5],
                                    "5": " <button id=" + s[i][0] + " data-toggle=\"modal\" class=\"btn btn-warning btn-xs\"  data-target=\"#myModal\"><span class=\"glyphicon glyphicon-file\"></span></button>",
